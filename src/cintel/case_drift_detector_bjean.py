...
REFERENCE_FILE: Final[Path] = DATA_DIR / "reference_metrics_bjean.csv"
CURRENT_FILE: Final[Path] = DATA_DIR / "current_metrics_bjean.csv"

OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_bjean.csv"
SUMMARY_LONG_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_long_bjean.csv"
